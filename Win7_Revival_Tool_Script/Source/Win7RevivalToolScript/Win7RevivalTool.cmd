...
IF "%ARCH%"=="x86" (
    echo %MessageDownload%
    start /wait "Win7RevivalTool: Downloader" "%~dp0Bin\Aria2\%ARCH%\aria2c.exe" -d %temp% https://github.com/win32ss/supermium/releases/latest/download/mini_installer_32.exe
	cls
	echo %MessageInstalling%
	echo.
    ...
    echo %MessageDownload%
    start /wait "Win7RevivalTool: Downloader" "%~dp0Bin\Aria2\%ARCH%\aria2c.exe" -d %temp% https://github.com/win32ss/supermium/releases/latest/download/mini_installer_64.exe
	cls
	echo %MessageInstalling%
	echo.
